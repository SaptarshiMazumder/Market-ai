...
# Downloads all base model files needed by the Dual LoRA + Z-Turbo + upscale workflow.
#
# LoRA files are NOT downloaded here — upload your trained LoRAs to:
#   /workspace/models/loras/<style_lora_name>.safetensors
#   /workspace/models/loras/<character_lora_name>.safetensors
#
# Usage:
...
echo ""
echo "Upload your trained LoRAs to: $VOLUME/models/loras/"
