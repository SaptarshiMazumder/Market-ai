...
# Downloads all base model files needed by the LoRA + Z-Turbo + upscale workflow.
#
# LoRA files are NOT downloaded here — upload your trained LoRA to:
#   /workspace/models/loras/<your_lora_name>.safetensors
#
# Usage:
...
echo ""
echo "Upload your trained LoRA to: $VOLUME/models/loras/"
